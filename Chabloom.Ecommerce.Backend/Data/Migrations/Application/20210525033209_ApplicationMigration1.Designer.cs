...
namespace Chabloom.Ecommerce.Backend.Data.Migrations.Application
{
    ...
    [Migration("20210525033209_ApplicationMigration1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chabloom.Ecommerce.Backend.Models.Auth.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "67789f6f-74c4-4719-bb9e-2f4d1b4b8e79",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "fc3ccdb2-cf6f-4b1f-972f-459a07eb714f",
                            Name = "Manager",
                            TenantId = new Guid("6a7e29dc-9eff-4f0d-bb14-51f63f142871")
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "d1b68753-bdf2-4263-b8ea-6af61d268322",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c282c374-f2c1-45b9-b19e-fafc0145593b",
                            Name = "Manager",
                            TenantId = new Guid("9cafce7f-d4a1-4874-b3c9-339836fd082c")
                        });
                });

            modelBuilder.Entity("Chabloom.Ecommerce.Backend.Models.Auth.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chabloom.Ecommerce.Backend.Models.Auth.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Chabloom.Ecommerce.Backend.Models.Inventory.Store", b =>
                {
                    b.HasOne("Chabloom.Ecommerce.Backend.Models.Auth.Tenant", "Tenant")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Chabloom.Ecommerce.Backend.Models.Auth.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Chabloom.Ecommerce.Backend.Models.Auth.User", null)
                        .WithMany()
